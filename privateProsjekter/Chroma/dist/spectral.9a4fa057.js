...
})({"iVzMJ":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "242bed7f9a4fa057";
"use strict";
...
},{}],"21VY2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _lmsdataCsv = require("./LMSdata.csv");
var _lmsdataCsvDefault = parcelHelpers.interopDefault(_lmsdataCsv);
var _chromaJs = require("chroma-js");
var _chromaJsDefault = parcelHelpers.interopDefault(_chromaJs);
fetch((0, _lmsdataCsvDefault.default)).then((res)=>res.text()).then((data)=>{
    ...
    for(let i = 0; i < results.data.length; i++)colorObject[results.data[i][0].toString()] = {
        'L': results.data[i][1],
        'M': results.data[i][2],
        'S': results.data[i][3],
    ...
    let NormalizedXYZ = normalizeXYZ([
        colorObject['450']['X'],
        colorObject['450']['Y'],
        colorObject['450']['Z']
    ]);
    ...
    for(let i = 390; i < 831; i++){
        ...
        wavelength.addEventListener('click', (e)=>{
            ...
            if (active.length > 0) active.classList.remove('.active');
...
},{"./LMSdata.csv":"MKiE1","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","chroma-js":"jSIg1"}],"MKiE1":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("LMSdata.41cbbc79.csv") + "?" + Date.now();

},{}]},["iVzMJ","21VY2"], "21VY2", "parcelRequirea7aa", {}, "./", "/")

//# sourceMappingURL=spectral.9a4fa057.js.map
